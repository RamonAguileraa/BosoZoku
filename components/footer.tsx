...
export default function Footer() {
  return (
    <footer className="relative bg-black border-t border-amber-900/30 py-16">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(139,69,19,0.1),rgba(0,0,0,0))]" />
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative w-12 h-12 rounded-full overflow-hidden border-2 border-amber-500/50 group-hover:border-amber-500 transition-colors">
                <Image
              ...
              <div>
                <span className="font-bold text-2xl bg-gradient-to-r from-amber-200 to-amber-400 bg-clip-text text-transparent">BosoZoku</span>
            ...
            <div className="flex space-x-4">
              <Link href="https://discord.gg/bosozoku" target="_blank" className="text-gray-400 hover:text-amber-400 transition-colors">
                <Discord className="h-6 w-6" />
              </Link>
              <Link href="https://twitter.com/bosozoku" target="_blank" className="text-gray-400 hover:text-amber-400 transition-colors">
                <Twitter className="h-6 w-6" />
              </Link>
              <Link href="https://instagram.com/bosozoku.studio" target="_blank" className="text-gray-400 hover:text-amber-400 transition-colors">
                <Instagram className="h-6 w-6" />
              </Link>
              <Link href="https://youtube.com/@BosoZokuStudio" target="_blank" className="text-gray-400 hover:text-amber-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-300">contacto@bosozoku.com</p>
